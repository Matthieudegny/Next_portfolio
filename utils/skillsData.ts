export const dataSkills = [
  {
    title: "Front-end",
    linkImage: "/frontEnd_skills.png",
    text: "UI/UX and responsive design: Experienced in creating visually \
  ...
  {
    title: "structure",
    text: "Clean coding: Skilled in writing maintainable and scalable code using \
    the MVC design pattern and TypeScript, ensuring code reliability and \
    type safety.",
  },
  {
    title: "Back-end",
    text: "API creation: Experienced in building robust and scalable APIs using \
  ...
  },
  {
    ...
    text: "Experienced in using Git, GitHub, and Azur for version control,\
  ...
  {
    title: "Current Focus",
    text: "working on improving my skills in Continuous Integration and \
