  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute w-full h-140px bottom-12 -ml-5  md:-top-10 xl:-top-8 -translate-x-1/2 z-10 flex justify-start items-start md:justify-center md:items-center text-center text-base `}
      >
